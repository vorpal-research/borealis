...
struct DOTGraphTraits<const DSGraph*> : public DefaultDOTGraphTraits {
	...
	DOTGraphTraits(bool simple = true) : DefaultDOTGraphTraits(simple) {};
  ...
  static std::string
  getNodeLabel(const DSNode *Node, const DSGraph *Graph, bool ShortNames = false) {
...
void DSGraph::viewGraph() const {
  ViewGraph(this, "ds.tempgraph", false, "DataStructures");
}
